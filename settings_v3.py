...
class AppConfig:
    ...
    def __init__(self):
        ...
        # --- PARÂMETROS FIXOS DA CONSOLIDAÇÃO ---
        # Origem A (ONLINE)
        self.db_online = "db_producao"
        self.tabela_online = "operacoes_online"
        
        # Origem B (BATCH)
        self.db_batch = "db_historico"
        self.tabela_batch = "operacoes_batch"
        
        # Configurações da Regra
        self.origem_preferida = "ONLINE"
    ...
    def _get_env(self, key: str, default: Any = None) -> Any:
        """Helper para buscar variáveis de ambiente."""
